...
public class SimpleConnectionMgr : MonoBehaviourPunCallbacks
{
    ...
    {
        // 닉네임 설정
        PhotonNetwork.NickName = "Zㅣ존V최준의V존ㅣZ";
        // 기본 Lobby 입장
    ...
    // Room 을 참여하자, 만약 해당 Room이 없으면 Room을 만들겠다.
    public void JoinOrCreateRoom()
    {
        ...
        // Room 참여 or 생성
        PhotonNetwork.JoinOrCreateRoom("meta_unity_room100", roomOption, TypedLobby.Default);
    }
