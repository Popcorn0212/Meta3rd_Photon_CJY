...
public class PhotonChatMgr : MonoBehaviour, IChatClientListener
{
    ...
    void Update()
    {
        // 채팅 서버에서 오는 응답을 수신하기 위해서 계속 호출 해야한다.
    ...
    // 특정 채널에 다른 사람(/나)이 메세지를 보내고 나한테 응답이 올 때 호출 되는 함수
